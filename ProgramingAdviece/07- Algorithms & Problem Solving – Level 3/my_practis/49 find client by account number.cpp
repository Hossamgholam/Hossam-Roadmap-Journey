...
int search_account(vector<client> your_vclient,string your_account){
    for(int i=0;i<your_vclient.size();i++){
        if(your_vclient[i].account_number==your_account){
            return i;
        }
    }
    return -1;
}
void print_result(int find,vector<client>your_vclient,string your_account){
    if(find!=-1){
        cout<<"the client is exist and information is\n";
        cout<<" your account_number:"<<your_vclient[find].account_number<<endl;
        cout<<" your pincode       :"<<your_vclient[find].pincode<<endl;

        cout<<" your name          :"<<your_vclient[find].name<<endl;
        cout<<" your phone         :"<<your_vclient[find].phone<<endl;
        cout<<" accountbalance     :"<<your_vclient[find].accountbalance<<endl;
    }
    else{
...
int main(){
    ...
    int find=search_account(vclient,account_number);
    print_result(find,vclient,account_number);
