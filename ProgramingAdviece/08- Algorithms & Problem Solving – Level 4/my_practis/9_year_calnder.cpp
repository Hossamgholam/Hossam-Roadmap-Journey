...
void print_monthe_calender(short your_monthe,short your_year){
    short number_day=number_day_monthe(your_year,your_monthe);
    short start_day=calculat_day_order(your_year,your_monthe,1);
    printf("_________________________%s_________________________________\n",monthe_name(your_monthe).c_str());
...
void print_year_calendar(short your_year){
    cout<<"_____________________________________________________________\n";
    cout<<"                 calander_"<<your_year<<"                    \n";
    cout<<"_____________________________________________________________\n\n";
    for(int i=1;i<12;i++){

        print_monthe_calender(i,your_year);
